...
@plasius/graph-events is part of the cached graph platform and needs a single responsibility with minimal overlap versus sibling packages.

## Decision

- Keep @plasius/graph-events focused on its package-specific concern only.
